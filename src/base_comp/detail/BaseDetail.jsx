...
const BaseDetail = function BaseDetail(props) {
    const {departDate, arriveDate, departTimeStr, arriveTimeStr,
        trainNumber, durationStr, departStation, arriveStation, } = props
